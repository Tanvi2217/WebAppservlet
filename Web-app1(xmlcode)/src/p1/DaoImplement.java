...
public class DaoImplement{
	...
	public String courseselect() throws SQLException{
		String nm = null;
		String query = "SELECT INSTRUCTORCOURSEINFO.coursename FROM INSTRUCTORCOURSEINFO JOIN USERCOURSE  ON (INSTRUCTORCOURSEINFO.instructorcode = USERCOURSE.instructorcode)";
		
		ps = con.prepareStatement(query);
		ResultSet rs = ps.executeQuery();
		while(rs.next()) {
			nm = rs.getString("coursename");
		}
		return nm;
